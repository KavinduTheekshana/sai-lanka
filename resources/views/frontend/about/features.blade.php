<div class="counter-section about-section bg-color2 w-100 float-start">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="counter-box">
                    ...
                    <div class="counter-text">
                        ...
                        <p>We prioritize customer satisfaction, tailoring solutions to meet unique business needs.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="counter-box">
                    ...
                    <div class="counter-text">
                        ...
                        <p>We embrace the latest technologies to build modern and efficient digital solutions. <br> <br></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="counter-box">
                    ...
                    <div class="counter-text">
                        <h4>24/7 Support</h4>
                        <p>Our team is available around the clock to provide seamless assistance whenever you need it.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="counter-box">
                    ...
                    <div class="counter-text">
                        ...
                        <p>We ensure secure, high-quality, and scalable solutions that businesses can rely on. <br> <br></p>
                    </div>
                </div>
            </div>
        </div>
