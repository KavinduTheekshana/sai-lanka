...
@section('content')
				...
				<div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display:none;"
					...
					<ul>
						...
						<li data-index="rs-3045" data-transition="zoomout" data-slotamount="default"
							...
							data-thumb="{{ asset('frontend/images/young-couple-using-mobile-phone-while-having-breakfast-together-home_58466-16007.jpg') }}" data-rotate="0" data-fstransition="fade"
							...
							data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{ asset('frontend/images/young-couple-using-mobile-phone-while-having-breakfast-together-home_58466-16007.jpg') }}" alt="img" data-bgposition="center center" data-bgfit="cover"
						...
						<li data-index="rs-3046" data-transition="fadetotopfadefrombottom" data-slotamount="default"
							...
							data-thumb="{{ asset('frontend/images/low-angle-friends-looking-phone_23-2148395408.jpg') }}" data-rotate="0" data-saveperformance="off"
							data-title="Find Match" data-param1="" data-param2="" data-param3="" data-param4=""
							data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""
							data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{ asset('frontend/images/low-angle-friends-looking-phone_23-2148395408.jpg') }}" alt="img" data-bgposition="center center" data-bgfit="cover"
								data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
							<!-- LAYERS -->
						...
						<li data-index="rs-3047" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0"
							...
							data-masterspeed="2000" data-thumb="{{ asset('frontend/images/stylish-couple-love-sitting-street-romantic-trip-taking-photo_285396-9911.jpg') }}" data-rotate="0"
							data-saveperformance="off" data-title="Create Profile" data-param1="" data-param2=""
							data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
							data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{ asset('frontend/images/stylish-couple-love-sitting-street-romantic-trip-taking-photo_285396-9911.jpg') }}" alt="img" data-bgposition="center center" data-kenburns="on"
						...
						<li data-index="rs-3049" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0"
							data-hideslideonmobile="off" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut"
							data-masterspeed="2000" data-thumb="{{ asset('frontend/images/restful-couple-connected-with-smartphone-coffee-shop_1098-420.jpg') }}" data-rotate="0"
							data-saveperformance="off" data-title="Start Dating" data-param1="" data-param2=""
							data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
							data-param9="" data-param10="" data-description="">
							<!-- MAIN IMAGE -->
							<img src="{{ asset('frontend/images/restful-couple-connected-with-smartphone-coffee-shop_1098-420.jpg') }}" alt="img" data-bgposition="center center" data-kenburns="on"
		...
		<div class="container">
			<div class="row align-items-end">
				...
				<div class="col-lg-6 col-md-12 col-12 order-lg-12">
					<img src="images/dating-img.png" alt="dating-img" class="img-fluid">
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="love-calculater w-100 float-start">
				<div class="love-result">
					...
					<img src="images/heart-img.png" alt="heart-img" class="img-fluid d-block d-lg-none">
					...
					<div class="item">
						<div class="slider-box">
							...
							<div class="slider-img zoomIn">
								<img src="images/slider-img.png" alt="slider-img" class="img-fluid">
							</div>
						</div>
					</div>
					<div class="item">
						<div class="slider-box">
							...
							<div class="slider-img zoomIn">
								<img src="images/slider-img1.png" alt="slider-img" class="img-fluid">
							</div>
						</div>
					</div>
					<div class="item">
						<div class="slider-box">
							...
							<div class="slider-img zoomIn">
								<img src="images/slider-img2.png" alt="slider-img" class="img-fluid">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="main-members-section bg-color1 w-100 float-start">
		<img class="shape1" src="images/heartshape.png" alt="img">
		<div class="container">
			<div class="heading center-heading">
			...
			<div class="w-100 float-start">
				<div class="row">
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img1.jpg" alt="members-img1" class="img-fluid">
							</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img2.jpg" alt="members-img2" class="img-fluid">
							</div>
							<div class="members-text">
								<a href="profile-single.html">
									<h6>Pari Parmar</h6>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img3.jpg" alt="members-img3" class="img-fluid">
							</div>
							<div class="members-text">
								<a href="profile-single.html">
									<h6>Tulshi Jat</h6>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img4.jpg" alt="members-img4" class="img-fluid">
							</div>
							<div class="members-text">
								<a href="profile-single.html">
									<h6>Vijay Chouhan</h6>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img5.jpg" alt="members-img1" class="img-fluid">
							</div>
							<div class="members-text">
								<a href="profile-single.html">
									<h6>Sarika Thakur</h6>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img6.jpg" alt="members-img2" class="img-fluid">
							</div>
							<div class="members-text">
								<a href="profile-single.html">
									<h6>Pari Parmar</h6>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img7.jpg" alt="members-img3" class="img-fluid">
							</div>
							<div class="members-text">
								<a href="profile-single.html">
									<h6>Tulshi Jat</h6>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-12">
						<div class="members-box">
							<div class="members-img">
								<img src="images/members-img8.jpg" alt="members-img4" class="img-fluid">
							</div>
							<div class="members-text">
								<a href="profile-single.html">
									<h6>Vijay Chouhan</h6>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-md-12 col-12 order-lg-12">
					<div class="mobile-img">
						<img src="images/app-img.png" alt="app-img" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="blog-box text-center">
							<div class="blog-img">
								<img src="images/blog-box-img1.jpg" alt="blog-box-img1" class="img-fluid">
							</div>
							<div class="blog-text">
								<ul class="tag-list">
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="blog-box text-center">
							<div class="blog-img">
								<img src="images/blog-box-img2.jpg" alt="blog-box-img2" class="img-fluid">
							</div>
							<div class="blog-text">
								<ul class="tag-list">
									<li><a href="javascript:;"><span><i class="fas fa-tags"></i></span> By Admin</a>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-12">
						<div class="blog-box text-center">
							<div class="blog-img">
								<img src="images/blog-box-img3.jpg" alt="blog-box-img3" class="img-fluid">
							</div>
							<div class="blog-text">
								<ul class="tag-list">
									<li><a href="javascript:;"><span><i class="fas fa-tags"></i></span> By Admin</a>
